/**
 * Splash Images Data
 * Images for the alternative splash component background rotation
 *
 * Add or remove images from the array to control the slideshow.
 * Each image should have:
 * - src: path to the image file
 * - alt: descriptive alt text for accessibility
 * - showOnMobile: boolean indicating if image should be shown in mobile rotation
 */
